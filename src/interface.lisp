...
(defclass implementation ()
  ((name
   ...
   (no-force-needed
    ...
    :documentation "When no-force-needed-p is T, the force argument 
of redraw-display is ignored.  In environments like ncurses, when the
upper window is modified, the lower window needs to be redrawn.  In 
that case, set the force of redraw-display to T.  When rendering the
DOM and a window in a one-to-one manner, no redraw is required.")
